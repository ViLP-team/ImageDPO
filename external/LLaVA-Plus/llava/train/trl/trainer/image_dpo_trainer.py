...
class Image_DPOTrainer(Trainer):
    r"""
    ...
    def concatenated_inputs(
        ...
        #]
        repeated_list = []
        for img_index in range(len(batch['good_image'])):
            repeated_list.append(batch['good_image'][img_index])
            repeated_list.append(batch['bad_image'][img_index])
