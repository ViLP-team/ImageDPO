...
from llava.train.llava_trainer import LLaVADPOTrainer_dpotrainer, LLaVATrainer

import sys
sys.path.insert(0,'/nfs/turbo/justincj-turbo/tiangel/improvingVLM/LLaVA/trl')
...
class DPODataCollator(DPODataCollatorWithPadding):
    ...
    def tokenize_batch_element(
        ...
        We also create the labels for the chosen/rejected responses, which are of length equal to
            the sum of the length of the  and the chosen/rejected response, with
...
def train():
    ...
    trainer = LLaVADPOTrainer_dpotrainer(
        model,
        args=training_args,
