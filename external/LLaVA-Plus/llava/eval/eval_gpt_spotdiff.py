...
if __name__ == "__main__":
    ...
    for item in generated_instructions[:100]:
        ...
        content = f"""
        We are conducting an evaluation of an AI assistant's ability to provide instructions for modifying images. The AI assistant was given a source image and a target image and tasked with predicting how the source image should be changed to match the target image.
        
        The AI assistant provided the following instruction: {cur_gen_instruction}
        The ground-truth instruction is: {cur_gt_instruction}
        
        Please provide your feedback by rating the AI assistant's performance on a scale of 0 to 10, where 10 signifies excellent performance and 0 represents the provided instruction is completely incorrect.
...
print("Spot Diff final score:", np.mean(score_results) * 10)
