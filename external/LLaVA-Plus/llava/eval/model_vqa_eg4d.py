...
def eval_model(args):
    ...
    instructions = read_jsonl_file(
        "/nfs/turbo/justincj-turbo/tiangel/improvingVLM/packages/LLaVA-Plus/playground/eval_data/two_img_dataset/COCO/gpt_qas_COCO.jsonl"
    )
    image_dir = "/nfs/turbo/justincj-turbo/tiangel/improvingVLM/packages/LLaVA-Plus/playground/eval_data/two_img_dataset/COCO/img"
