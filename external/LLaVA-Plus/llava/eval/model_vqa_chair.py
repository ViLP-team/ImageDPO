...
def eval_model(args):
    ...
    #model_name = 'llava-onevision-qwen2-7b-lora'
    model_name = get_model_name_from_path(model_path)
    ...
    #    )
    #)
    img_list = pickle.load(open('/nfs/turbo/justincj-turbo/tiangel/improvingVLM/packages/LLaVA-Plus/playground/eval_data/single_img_dataset/Hallucination/CHAIR_img_list.pkl', 'rb'))
...
if __name__ == "__main__":
    ...
    #parser.add_argument("--conv-mode", type=str, default="llava_qwen")
