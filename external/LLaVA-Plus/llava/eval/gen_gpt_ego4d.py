...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-o",
        "--output",
        default="/nfs/turbo/justincj-turbo/tiangel/improvingVLM/packages/LLaVA-Plus/playground/eval_data/two_img_dataset/EGO4D/gpt_qsa_ego4d.jsonl",
    ...
    test_path = pickle.load(
        open(
            "/nfs/turbo/justincj-turbo/tiangel/improvingVLM/packages/LLaVA-Plus/eval_data/two_img_dataset/EGO4D/sampled_frames.pkl",
            "rb",
        )
    )
    ...
    for i in range(len(pairs)):
        ...
        content = f"""
        Given two images sampled from a egocentric video clip, please design some questions and give their corresponding answers.
