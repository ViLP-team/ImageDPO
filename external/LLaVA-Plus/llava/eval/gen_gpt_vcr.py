...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-o",
        "--output",
        default="/nfs/turbo/justincj-turbo/tiangel/improvingVLM/packages/LLaVA-Plus/playground/eval_data/two_img_dataset/VCR/vcr_video/gpt_qsa_vcr.jsonl",
        help="output file to save the generated questions",
    )
    parser.add_argument(
        "--test_path",
        default="/nfs/turbo/justincj-turbo/tiangel/improvingVLM/packages/LLaVA-Plus/eval_data/two_img_dataset/VCR/vcr_video/sampled_frames.pkl",
    )
    parser.add_argument(
        "--mode",
        default="image",
    ...
    if args.mode == "image":
        args.output = "/nfs/turbo/justincj-turbo/tiangel/improvingVLM/packages/LLaVA-Plus/playground/eval_data/two_img_dataset/VCR/vcr_img/gpt_qsa_vcr.jsonl"
